...
const ViewAllItemScreen = ({ navigation }) => {
    ...
    return (
        ...
        <SafeAreaView style={styles.container} edges={["top", "left", "right"]}>
            ...
            />
            <View style={{ position: 'absolute', height: '85%', marginRight: 10, width: wp(5), backgroundColor: colors.lighterGrey, zIndex: 5000, right: 0, marginTop: hp(15), alignItems: 'center', borderRadius: 10, justifyContent: 'center' }}>
